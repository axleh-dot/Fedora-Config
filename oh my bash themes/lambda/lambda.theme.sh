...
_omb_prompt_darkblue='\[\e[38;5;33m\]'   # celeste oscuro
_omb_prompt_fg_white='\[\e[97m\]'           # texto blanco brillante
_omb_prompt_reset='\[\e[0m\]'               # reset
...
#  PS1+=$icon_user$_omb_prompt_bold_brown'\u'
  PS1+=$_omb_prompt_darkblue$icon_host
  PS1+=$_omb_prompt_bold_purple'(\W)'
  PS1+=$_omb_prompt_normal$([[ -n $(_omb_prompt_git branch 2> /dev/null) ]] && _omb_util_print "${icon_branch}")
